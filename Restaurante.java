/**
 * Classe que simboliza as empresas do tipo restaurante
 */
public abstract class Restaurante extends Restauracao {
     ...
     * @return o número de dias de funcionamento do estabelecimento por ano
     */
     ...
     * @param diasFuncionamento o número de dias de funcionamento do estabelecimento por ano
     */
